...
Usage:
    python improved_inject_test.py [path_to_dll] [target_process]

Examples:
    python improved_inject_test.py                     # Uses default DLL and notepad.exe
    python improved_inject_test.py custom_test.dll     # Uses custom DLL and notepad.exe  
    python improved_inject_test.py test.dll calc.exe   # Uses test.dll and calc.exe
